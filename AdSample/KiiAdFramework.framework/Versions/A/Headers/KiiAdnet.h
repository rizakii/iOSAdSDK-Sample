...
/** Generate an instance of KiiAdNet
 ...
 @param site One of the enumerator constants kiiAdSiteUS (United States) or kiiAdSiteJP (Japan), based on your desired location
 @return An instance of KiiAdNet
 */
+ (id) requestAdWithDelegate:(UIViewController*)del
           withApplicationId:(NSString*)aid
              applicationKey:(NSString*)akey
                     andSite:(KiiAdSite)site;
